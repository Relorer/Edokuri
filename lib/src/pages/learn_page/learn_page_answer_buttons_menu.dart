    ...
    return Row(
      children: [
        LearnPageAnswerButton(
          onTap: () => {learnController.markRecordAgain(), learnController.answerIsShown = false},
          topText: "< 1 min",
          bottomText: "again",
          color: const Color(0xFFCE4003),
        ),
        LearnPageAnswerButton(
          onTap: () => {learnController.markRecordHard(), learnController.answerIsShown = false},
          topText: "< 10 min",
          bottomText: "hard",
          color: Colors.white,
        ),
        LearnPageAnswerButton(
          onTap: () => {learnController.markRecordGood(), learnController.answerIsShown = false},
          topText: "1d",
          bottomText: "good",
          color: const Color(0xFF34A853),
        ),
        LearnPageAnswerButton(
          onTap: () => {learnController.markRecordEasy(), learnController.answerIsShown = false},
          topText: "4d",
          bottomText: "easy",
